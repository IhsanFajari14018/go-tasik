		...
		<div class="album py-5">
			<div class="container">
				<div class="row">
					...
					<?php foreach($daftar_kuliner as $d){ ?>
						...
						<div class="col-md-12 mb-2">
							<div class="card">
								<div class="row no-gutters">
									<div class="col-md-3">
										<!-- <a href="<?php //echo site_url("pariwisata/detail_kuliner/getDetailKuliner/".$d->id_pariwisata) ; ?>"> -->
										<a href="<?php echo site_url("detail_kuliner/".$d->id_pariwisata) ; ?>">
