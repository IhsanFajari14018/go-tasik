	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
		<div class="container">
			...
			<div class="collapse navbar-collapse mr-auto" id="navbarsExample08">
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="navbar-brand" href="#"><span class="font-weight-bolder">go-tasik</span></a>
					</li>
					<li class="nav-item">
			...
			<form class="form-inline">
				<div class="input-group form-sm form-2 pl-2 mt-3">
					<input class="form-control" type="text" placeholder="Cari pariwisata" aria-label="Search">
					<div class="input-group-append">
						<button class="input-group-text teal" type="submit" style="border-style: none;">
							<i class="fa fa-search text-white" aria-hidden="true"></i>
						</button>
						<!-- <button class="btn btn-mdb-color btn-rounded btn-sm py-2 ml-0" type="submit">A</button> -->
					</div>
				</div>
			</form>
		</div>
